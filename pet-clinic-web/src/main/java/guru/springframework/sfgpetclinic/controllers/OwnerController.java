...
@Controller
@RequestMapping("owners")   // route for every action in the controller will have "owners" prepended
public class OwnerController {
    ...
    // Dissalows posting id in forms to bind to Java object.
    // We do not want someone to manipulate the id property.
    @InitBinder
